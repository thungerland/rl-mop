...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train BabyAI GRU Policy')
    ...
    # Initial GRU hidden state: [num_layers=1, batch=num_envs, hidden_size]
    ...
    for update in trange(1, num_updates + 1):
        ...
        h, avg_loss, avg_acc = train_unroll(
            policy, 
            optimizer, 
            vec_env, 
            h, 
